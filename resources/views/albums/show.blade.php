    ...
    <div class="container mx-auto m-2 p-2 bg-white shadow-md rounded-lg">
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
            <form method="POST" action="{{ route('ablums.upload', $album->id) }}" enctype="multipart/form-data">
                ...
                <div class="sm:col-span-6 pt-5" style="margin-top: 7px">
                    <x-primary-button class="bg-green-500">Upload</x-primary-button>
                </div>
            </form>
        </div>
        <div class="mt-4">
            <div class="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
                @foreach ($photos as $photo)
                    <div class="bg-gray-300 p-2 flex justify-center">
                        <a class="inline relative h-56 rounded overflow-hidden">
                            <img alt="gallery" class="object-cover object-center w-full h-full inline"
